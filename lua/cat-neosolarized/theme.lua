...
function M.setup()
	...
	theme.highlights = {
		...
		CurrentWord =  { fg = c.green, bg = c.bg0 },
		...
		--[[
      language specific settings are needed to be kept from here.
    ...
    --]]
		...
		cmakeKWcmake_host_system_information =    { fg = c.cyan }, -- tragedy
